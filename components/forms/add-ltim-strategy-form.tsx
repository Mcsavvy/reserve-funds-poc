...
export function AddLtimStrategyForm({ onSuccess, onAdd }: { 
  onSuccess: () => void; 
  onAdd: (strategy: any) => Promise<any> 
}) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Failed to add LTIM strategy:', error);
    }
  };
  ...
  return (
    <>
      <DialogHeader>
        <DialogTitle>Add LTIM Strategy</DialogTitle>
        <DialogDescription>
          Create a new Long-Term Investment Management strategy with custom rate buckets.
        </DialogDescription>
      </DialogHeader>
